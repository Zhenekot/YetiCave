...
<body>
    <div class="page-wrapper">
        <header class="main-header">
            <div class="main-header__container container">
                ...
                <a class="main-header__add-lot button <?php if (!isset($_SESSION['is_auth']) || !$_SESSION['is_auth']): ?>visually-hidden<?php endif; ?> "
                ...
                <nav class="user-menu">
                    <?php if (isset($_SESSION['is_auth']) && $_SESSION['is_auth']): ?>
                        <div class="user-menu__logged">
                            ...
                            <a class="user-menu__bets" href="bets-user.php">Мои ставки</a>
    ...
    <footer class="main-footer">
        ...
        <div class="main-footer__bottom container">
            ...
            <a class="main-footer__add-lot button <?php if (!isset($_SESSION['is_auth']) || !$_SESSION['is_auth']): ?>visually-hidden<?php endif; ?>"
                href="add.php">Добавить лот</a>
